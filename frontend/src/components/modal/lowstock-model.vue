        ...
        <div class="modal-body add">
          <div class="addnew-modal">
                            ...
                            <tr>
                              ...
                              <td class="d-flex align-items-center">
                                <a class="btn-action-icon me-2" href="javascript:void(0);"
                                  ><i class="feather featherer feather-edit"></i
                                ></a>
            ...
            <div class="modal-footer add">
              <a href="javascript:;" data-bs-dismiss="modal" class="btn btn-success me-2"
                ><i class="fa-solid fa-arrow-down"></i>Credit</a
              >
              <a href="javascript:;" data-bs-dismiss="modal" class="btn btn-danger"
                ><i class="fa-solid fa-arrow-up"></i>Add New</a
              >
            </div>
          </div>
        </div>
                ...
                <div id="checkBoxes3">
                  <div class="selectBox-cont">
                    <label class="custom_check w-100">
                      ...
                      <span class="checkmark"></span> PPT001
                    </label>
                    <label class="custom_check w-100">
                      <input type="checkbox" name="sku" />
                      <span class="checkmark"></span> PPT005
                    </label>
                    <label class="custom_check w-100">
                      <input type="checkbox" name="sku" />
                      <span class="checkmark"></span> PPT010
                    </label>
                    <label class="custom_check w-100">
                      <input type="checkbox" name="sku" />
                    ...
                    <div class="view-content">
                      <div class="viewall-Two">
                        <label class="custom_check w-100">
                          <input type="checkbox" name="sku" />
                          <span class="checkmark"></span> PPT0050
                        </label>
                      </div>
                      <div class="view-all">
              ...
              <div class="card-body-chat">
                <div id="checkBoxes4">
                  <div class="selectBox-cont">
                    ...
                    <label class="custom_check w-100">
                      <input type="checkbox" name="category" />
                      <span class="checkmark"></span> Shoe
                    </label>
                    <label class="custom_check w-100">
                      <input type="checkbox" name="category" />
