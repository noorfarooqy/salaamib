        ...
        <ul class="filter-list">
          ...
          <li>
            <a class="btn btn-import" href="javascript:void(0);"
              ><span><i class="feather feather-inbox me-2"></i>Import Customer</span></a
            >
          </li>
          <li>
            <router-link class="btn btn-primary" to="/invoices/add-invoice"
              ><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>New
              Invoice</router-link
            >
          </li>
        </ul>
