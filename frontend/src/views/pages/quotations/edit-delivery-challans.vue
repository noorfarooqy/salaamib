                ...
                <div class="delivery-card">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="input-block mb-3">
                        <label>Tax</label>
                        <vue-select :options="Tax" id="taxedit" placeholder="No Tax" />
                      </div>
                    </div>
                    <div class="col-md-4"></div>
                  </div>
                  <div class="form-group-item border-0 p-0 mt-3">
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-lg-12">
                        <div class="form-group-bank">
                          ...
                          <div class="form-group mb-0 mt-3">
                            ...
                            <div
                              class="form-group service-upload service-upload-info mb-0"
                            >
                              <span
                  ...
                  <div class="text-end mt-4">
                    <router-link
                      ...
                      >Cancel</router-link
                    >
                    <router-link to="delivery-challans" class="btn btn-primary"
                      >Save</router-link
                    >
                  </div>
                </div>
