    ...
    <div class="card-body pb-0">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-xl-3 col-sm-12 d-md-flex d-sm-block" v-for="(image, index) in galleryImages" :key="index"
          @click="() => show(index)">
          <div class="blog grid-blog invoice-blog flex-fill d-flex flex-wrap align-content-betweens">
            <div class="blog-image">
              <a href="javascript:;" class="img-general"><img class="img-fluid"
                  :src="require(`@/assets/img/${image.src}`)" alt="Post Image" />
              </a>
              <a href="javascript:;" class="preview-invoice image-popup"><i class="fa-regular fa-eye"></i></a>
            </div>
