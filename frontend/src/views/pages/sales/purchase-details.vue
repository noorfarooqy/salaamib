            ...
            <div class="content-invoice-header">
              ...
              <div class="list-btn">
                <ul class="filter-list">
                  <li>
                    <a class="btn btn-import me-2" href="javascript:window.print()"><span><i
                          class="feather feather-printer me-2"></i>Print</span></a>
                  </li>
                  <li>
                    <a href="javascript:;" class="btn btn-primary" download><i class="fa fa-download me-2"
                    ...
                    <div class="card-bod">
                      ...
                      <div class="invoice-item invoice-item-date">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <p class="text-start invoice-details">
                              Due Date<span>: </span><strong>03 Jun 2023</strong><span class="text-danger">Due in 8
                                days</span>
                            </p>
                          </div>
                          <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <div class="invoice-info invoice-info2 mb-3">
                              ...
                              <p class="text-start invoice-details-t invoice-details">
                                Payment Term<span>: </span><strong>15 days</strong><span class="text-danger">Due in 8
                                  days</span>
                              </p>
                              <div class="pay-btn">
                                <a href="javascript:void(0);" class="btn btn-primary mt-2" data-bs-toggle="modal"
                      ...
                      <div class="terms-conditions">
                        <div class="row align-items-center justify-content-between">
                          <div class="col-lg-6 col-md-6">
                            ...
                            <div class="invoice-terms align-center">
                              <span class="invoice-terms-icon bg-white-smoke me-3">
                                <i class="feather feather-file-minus"></i>
                              </span>
                              <div class="invocie-note">
                                <h6>Note</h6>
                                <p class="mb-0">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="input-block mb-3 paynow-tab">
              <ul class="nav nav-pills d-flex row" id="pills-tab" role="tablist">
                ...
                <li class="nav-item col-sm-4" role="presentation">
                  <button class="nav-link cheque" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button"
        ...
        <div class="modal-footer">
          ...
          <a href="javascript:;" data-bs-dismiss="modal" class="btn btn-primary paid-continue-btn">pay Now</a>
        </div>
      </div>
    </div>
  </div>
