...
const columns = [
  ...
  },
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.CancelledAmount.toLowerCase();
        b = b.CancelledAmount.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
...
export default {
  setup() {
    return {
      title: "Cancelled Invoices Cancelled",
      path: "/invoices/add-invoice",
      text: "New Invoice",
      Delete: "Delete Invoice Cancelled",
      data,
      columns,
    };
  },
