                ...
                <a-table :columns="columns" :data-source="data">
                  <template #bodyCell="{ column, record }">
                    ...
                    <template v-else-if="column.key === 'Status'">
                      <span class="badge bg-light-gray text-primary">{{
                        record.Status
                      }}</span></template>
...
const columns = [
  ...
  {
    title: "Draft Amount",
    dataIndex: "DraftAmount",
    sorter: {
      compare: (a, b) => {
        a = a.DraftAmount.toLowerCase();
        b = b.DraftAmount.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
...
export default {
  setup() {
    return {
      title: "Recurring Invoices Draft",
      path: "/invoices/add-invoice",
      text: "New Invoice",
      Delete: "Delete Invoice Draft",
      data,
      columns,
    };
  },
