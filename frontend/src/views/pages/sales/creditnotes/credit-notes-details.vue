            ...
            <ul class="filter-list">
              <li>
                <a class="btn btn-import me-2" href="javascript:void(0);"
                  ><span><i class="feather feather-printer me-2"></i>Print</span></a
                >
              </li>
              <li>
                <a href="javascript:;" class="btn btn-primary" download
                  ><i class="fa fa-download me-2" aria-hidden="true"></i>Download</a
                >
              </li>
            </ul>
          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <p class="text-start invoice-details">
                          Date<span>: </span><strong>05/12/2023</strong>
                        </p>
                      </div>
                      <div class="col-md-6">
