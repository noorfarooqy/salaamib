        ...
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="clipboard">
                <form class="form-horizontal">
                  ...
                  <b-button @click="doCopy5" class="mb-1 btn me-1 clip-btn btn-primary">
                    <i class="far fa-copy"></i> Copy from Input
                  </b-button>
                  <b-button @click="doCut5" class="mb-1 btn clip-btn btn-dark">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="clipboard">
                <form class="form-horizontal">
                  <b-form-textarea class="form-control mb-4" v-model="message2" rows="3" id="paragraph-copy3"
                    placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit...">
                  </b-form-textarea>
                  <b-button type="button" @click="doCopy4" class="mb-1 btn me-1 clip-btn btn-primary">
                    <i class="far fa-copy"></i> Copy from Input
                  </b-button>
                  <b-button type="button" @click="doCut4" class="mb-1 btn clip-btn btn-dark">
                    <i class="fas fa-cut"></i> Cut from Input
                  </b-button>
                </form>
              </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="clipboard copy-txt">
                ...
                <b-button type="button" @click="doCopy2" class="mb-1 btn clip-btn btn-primary">
                  <i class="far fa-copy"></i> Copy from Input
                </b-button>
              </div>
            </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="clipboard copy-txt">
                ...
                <b-button type="button" @click="doCopy3" class="mb-1 btn me-1 clip-btn btn-primary">
                  <i class="far fa-copy"></i> Copy Link
                </b-button>
                <b-button type="button" @click="doCut1" class="mb-1 btn clip-btn btn-warning">
