        ...
        (function () {
          function A(e, t) {
            ...
            if (
              ...
              (this.options.text = Object.prototype.hasOwnProperty.call(
                this.options,
                "text"
              )
                ? this.options.text
                : { chooseFile: "Choose file..." }),
              (this.options.text.chooseFile = Object.prototype.hasOwnProperty.call(
                this.options.text,
                "chooseFile"
              )
                ...
                : "Choose file..."),
              this.options.text &&
              Object.prototype.hasOwnProperty.call(this.options.text, "browse")
