          ...
          <div class="card">
            <div class="card-header">
              ...
              <p class="card-text">
                ...
                validation
                <a href="https://getbootstrap.com/docs/4.1/components/forms/#server-side" target="_blank">read full
                  documentation</a>.
              </p>
            </div>
            <div class="card-body">
                ...
                <div class="col-sm">
                  <form class="was-validated">
                    <div class="custom-checkbox mb-3">
                      <input type="checkbox" class="form-check-input me-1" id="customControlValidation1" required />
                      <label for="customControlValidation1">Check this custom checkbox</label>
                      <div class="invalid-feedback">Example invalid feedback text</div>
                    </div>
                    <div class="custom-radio">
                      <input type="radio" class="form-check-input me-1" id="customControlValidation2" name="radio-stacked"
                        required />
                      <label for="customControlValidation2">Toggle this custom radio</label>
                    </div>
                    <div class="custom-radio mb-3">
                      <input type="radio" class="form-check-input me-1" id="customControlValidation3" name="radio-stacked"
                        required />
