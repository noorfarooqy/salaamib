                ...
                <a-table :columns="columns" :data-source="data">
                  <template #bodyCell="{ column, record }">
                    ...
                    <template v-else-if="column.key === 'Status'">
                      <span v-if="record.Status === 'Pending'" class="badge bg-warning-light text-warning-light">{{
                        record.Status }}</span>
                      <span v-else-if="record.Status === 'Resolved'" class="badge bg-success-light">{{ record.Status
                      }}</span>
                      <span v-else-if="record.Status === 'Closed'" class="badge bg-light-gray text-secondary">{{
                        record.Status }}</span>
                      <span v-else-if="record.Status === 'Open'" class="badge bg-primary-light">{{ record.Status
                      }}</span></template>
...
const data = [
  ...
  },
  {
    ...
    Assigned: "Sharonda",
    AssignedDate: "28 Jan 2023",
    CreatedOn: "29 Jan 2023, 6:12PM",
    DueDate: "28 Mar 2023",
    Assignee: "Robert",
    num: "+1 843-443-5298",
    LastReply: "21 Jan 2023",
  ...
  },
  {
    ...
    Subject: "Management",
    Assigned: "Sharonda",
    AssignedDate: "27 Feb 2023",
    CreatedOn: "28 Feb 2023, 6:12PM",
    DueDate: "29 Mar 2023",
    Assignee: "Sharonda",
    num: "+1 843-443-5298",
