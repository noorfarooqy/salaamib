<template>
  <div class="settings-icon">
    <span
      ...
      ><img src="@/assets/img/icons/siderbar-icon2.svg" class="feather-five" alt="layout"
    /></span>
  </div>
  <div
...
export default {
  ...
  mounted() {
    !(function () {
      ...
      function t() {
        ...
        b &&
          ...
          ((c = document.createElement("ul")).innerHTML =
            '<a href ="javascript:void(0);" class="logo"><img src="assets/img/logo.png" alt="User Image" height="22"></a>'),
          Array.from(
                ...
                a.parentElement.closest(".collapse.menu-dropdown")
                  ? (a.classList.add("show"),
                    ...
                    a.parentElement.parentElement.parentElement.parentElement.closest(
                      ...
                      ((b = a.parentElement.parentElement.parentElement.parentElement
                        .closest(".collapse.menu-dropdown")
                        .getAttribute("id")),
                      a.parentElement.parentElement.parentElement.parentElement
                        .closest(".collapse.menu-dropdown")
            ...
            default:
              ...
              "dark" == sessionStorage.getItem("data-layout-mode")
                ...
                : (sessionStorage.setItem("data-layout-mode", "orange"),
                  document.documentElement.setAttribute("data-layout-mode", "orange"),
      ...
      function G(a, b) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(function (
          c
        ) {
      ...
      function x() {
        ...
        Array.from(document.getElementsByClassName("cart-item-price")).forEach(function (
          ...
          document.getElementById("cart-item-total") &&
            (document.getElementById("cart-item-total").innerHTML = "$" + a.toFixed(2));
      }
        ...
        Array.from(a).forEach(function (d) {
          ...
          "flatpickr" == d.getAttribute("data-provider")
            ? ((a = {}),
              ...
              c["data-altFormat"] &&
                ((a.altInput = !0), (a.altFormat = c["data-altFormat"].value.toString())),
              c["data-minDate"] &&
    ...
    const radioButtons = document.querySelectorAll('input[name="data-layout"]');

    radioButtons.forEach((radioButton) => {
      radioButton.addEventListener("click", function () {
        if (this.checked) {
          const selectedValue = this.value;
          document.body.setAttribute("data-layout", selectedValue);
        }
      });
    });

    const radioButton = document.querySelectorAll('input[name="data-sidebar"]');

    radioButton.forEach((radioButton) => {
      radioButton.addEventListener("click", function () {
        if (this.checked) {
          const selectedValue = this.value;
          document.body.setAttribute("data-sidebar", selectedValue);
        }
      });
    });
  },
